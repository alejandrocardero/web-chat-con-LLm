...
# 3. Asegúrate de tener Ollama instalado y un modelo descargado
ollama pull glm-4.6:cloud
...
**Nota:** La carpeta `node_modules` NO está incluida en el repositorio. 
Ejecuta `npm install` para descargar las dependencias automáticamente.
