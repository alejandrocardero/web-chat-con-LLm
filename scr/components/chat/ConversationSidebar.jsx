  ...
  return (
    <div className="flex flex-col h-full bg-sidebar border-r border-sidebar-border w-full sm:w-72 md:w-64 pb-[env(safe-area-inset-bottom,0px)]">
      ...
      <div className="flex items-center justify-between px-3 md:px-4 py-3 md:py-4 border-b border-border">
        <h1 className="text-sm md:text-base font-semibold text-foreground tracking-tight">Chat con SLMs</h1>
      ...
      <div className="border-t border-border p-3 space-y-2">
        ...
        <div className="flex gap-1.5">
          <Button
            ...
            className="flex-1 justify-start gap-1.5 text-muted-foreground hover:text-foreground hover:bg-sidebar-accent text-xs"
          >
          ...
          <Button
            ...
            className="justify-start gap-1.5 text-muted-foreground hover:text-red-400 hover:bg-red-400/10 text-xs"
          >
